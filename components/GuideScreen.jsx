            ...
            <ScrollView showsVerticalScrollIndicator={false} className="h-full pt-6 w-5/6 mx-auto">
                ...
                <View>
                    ...
                    <View>
                        ...
                        <Text className="text-base font-medium text-gray-500 mb-2">кабинет врача-терапевта, который обслуживает работников, застрахованных в рамках добровольного медицинского страхования на случай болезни. Чтобы попасть на прием необходимо позвонить в Call-центр по номерам: 8 800 080 7676, 8(7172) 79 76 76 и записаться к терапевту</Text>
